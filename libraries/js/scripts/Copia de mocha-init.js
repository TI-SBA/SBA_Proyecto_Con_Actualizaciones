...
initializeColumns = function() {
	...
	new MUI.Panel({
		id: 'files-panel',
		title: 'Examples',		
		contentURL: url_base + 'libraries/pages/file-view.html',
		column: 'sideColumn1',
		require: {
			css: [url_base + MUI.path.plugins + 'tree/css/style.css'],			
			js: [url_base + MUI.path.plugins + 'tree/scripts/tree.js'],
			onload: function(){
		...
		onContentLoaded: function(){		
			$('notesLink').addEvent('click', function(e){
				MUI.updateContent({
					element: $('mainPanel'),					
					url: url_base + 'libraries/pages/notes.html',
			...
			$('xhrLink').addEvent('click', function(e){
				MUI.updateContent({
					element: $('mainPanel'),
					url: url_base + 'libraries/pages/lipsum.html',
					title: 'Lorem Ipsum',
					padding: { top: 8, right: 8, bottom: 8, left: 8 }
				});
			});
			...
			$('calendarLink').addEvent('click', function(e){
				MUI.updateContent({
					element: $('mainPanel'),
					url: url_base + MUI.path.plugins + 'calendar/example.html',
			...
			$('fxmorpherLink').addEvent('click', function(e){
				MUI.updateContent({
					element: $('mainPanel'),
					url: url_base + MUI.path.plugins + 'Fx.Morpher/',
	...
	new MUI.Panel({
		id: 'panel2',
		title: 'Ajax Form',
		contentURL: url_base + 'libraries/pages/ajax.form.html',
		column: 'sideColumn1',
		height: 230,
		onContentLoaded: function(){
	...
	new MUI.Panel({
		...
		column: 'mainColumn',
		headerToolbox: true,
		headerToolboxURL: 'libraries/pages/toolbox-demo2.html',
	...
	new MUI.Panel({
		...
		height: 200,	
		headerToolbox: true,
		headerToolboxURL: url_base +  'libraries/pages/console.toolbox.html',
		headerToolboxOnload: function(){
	...
	new MUI.Panel({
		id: 'help-panel',
		contentURL: url_base + 'libraries/pages/overview.html',
		column: 'sideColumn2',
		tabsURL: url_base +  'libraries/pages/panel-tabs.html',
		require: {
			css: [MUI.themePath() + 'css/Tabs.css']
		}		
	});
	...
	new MUI.Panel({
		id: 'tips-panel',
		title: 'Tips',
		contentURL: url_base + 'libraries/pages/tips.html',
		column: 'sideColumn2',
		height: 140,
		footer: true
	});
