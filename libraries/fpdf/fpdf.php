...
function Head()
{
	$lines = file(DIR_LIBRARIES.'\fpdf\empresa.txt');
	foreach ($lines as $line_num => $line) { 
		$datos = explode(",", $line); 
	}
	$this->SetFont('Arial','B',10);
    $this->Cell(40,6,$datos[0],0,0,'C',0);
	$this->Ln(4);
	$this->SetFont('Arial','',7);
	$this->Cell(40,6,'Direccion: '.$datos[1],0,0,'C',0);$this->Ln(4);
    $this->Cell(40,6,'Fono: '.$datos[2],0,0,'l',0);$this->Ln(4);
    $this->Cell(40,6,'RUC: '.$datos[3],0,0,'L',0);
...
function Foot()
{
    ...
    $this->Cell(0,6,'Fecha de Impresion: '.date("Y-m-d"),0,0,'R',0);
