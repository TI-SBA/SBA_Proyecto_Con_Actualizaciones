	...
	return {
		...
		init : function(elem, opts) {
			...
			if(this.settings.rules.draggable != "none" && this.settings.rules.dragrules != "none") {
				...
				$("<img>")
					.attr({
						id		: "marker", 
						//src	: _this.path + "../images/treecomponent/marker.gif"
						src	: "../../themes/kunanui/images/treecomponent/marker.gif"
					})
					.css({
						height		: "5px",
						width		: "40px",
							...
							if(_this.isdown) {
								...
								if( cnt.get(0) != _this.container.get(0) && (!_this.settings.rules.multitree || !tree_component.inst[cnt.attr("id")].settings.rules.multitree) ) {
									if($(_this.drag).children("IMG").size() == 0) {
										$(_this.drag).append("<img style='position:absolute; " + (_this.settings.ui.rtl ? "right" : "left" ) + ":4px; top:0px; background:white; padding:2px;' src='../../themes/kunanui/images/treecomponent/remove.png' />");
									}
									_this.moveType = false;
									_this.moveRef = false;
									$("#marker").hide();
								...
								if(event.target.tagName == "A" ) {
									...
									if(tree_component.inst[cnt.attr("id")].checkMove(_this.container.find("li.dragged"), $(event.target), mov)) {
										if(mov == "inside")	$("#marker").attr("src", "../../themes/kunanui/images/treecomponent/plus.gif").width(11);
										else {
											if(cnt.hasClass("rtl"))	{ $("#marker").attr("src","../../themes/kunanui/images/treecomponent/marker_rtl.gif").width(40); }
											else					{ $("#marker").attr("src", "../../themes/kunanui/images/treecomponent/marker.gif").width(40); }
										}
										_this.moveType	= mov;
		...
		open_branch : function (obj, disable_animation, callback) {
			...
			if(this.settings.data.async && obj.find("li").size() == 0) {
				var _this = this;
				obj.children("ul:eq(0)").remove().end().append("<ul><li class='last'><a style='background-image:url('../../themes/kunanui/images/treecomponent/throbber.gif)' href='#'>" + (_this.settings.lang.loading || "Loading ...") + "</a></li></ul>");
