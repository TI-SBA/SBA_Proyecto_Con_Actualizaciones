...
(function($) { // Create closure.
  ...
  $.fn.dashboard = function(options) {
    ...
    $('#' + dashboard.id + ' .menutrigger').die('click').live('click', function() {
    ...
    $('#' + dashboard.id + ' .' + opts.widgetFullScreenClass).die('click').live('click',function(e) {
      // close the menu
    ...
    $('#' + dashboard.id + ' .controls li').die('click').live('click',function(e) {
      // close the menu
      dashboard.log('widgetCloseMenu event thrown for widget ' + widget.id,2);
    ...
    $('#' + dashboard.id + ' .' + opts.widgetClass).die('widgetCloseMenu').live('widgetCloseMenu',function(e,o) {
      dashboard.log("Closing menu " + $(this).attr("id"),1);
      o.widget.closeMenu();
    });

    $('#' + dashboard.id + ' .' + opts.widgetClass).die('widgetOpenMenu').live('widgetOpenMenu',function(e,o) {
      dashboard.log("Opening menu " + $(this).attr("id"),1);
      o.widget.openMenu();
    });

    $('#' + dashboard.id + ' .' + opts.widgetClass).die('widgetDelete').live('widgetDelete',function(e,o) {
    ...
    $('#' + dashboard.id + ' .' + opts.widgetClass).die('widgetRefresh').live('widgetRefresh',function(e,o) {
      o.widget.refreshContent();
    });

    $('#' + dashboard.id + ' .' + opts.widgetClass).die('widgetSetTitle').live('widgetSetTitle',function(event, o) {
      o.widget.setTitle(o.title);
    });

    $('#' + dashboard.id + ' .' + opts.widgetClass).die('widgetClose').live('widgetClose',function(e,o) {
      dashboard.log("Closing widget " + $(this).attr("id"),1);
      o.widget.closeContent();
    });

    $('#' + dashboard.id + ' .' + opts.widgetClass).die('widgetOpen').live('widgetOpen',function(e,o) {
      dashboard.log("Opening widget " + $(this).attr("id"),1);
      o.widget.openContent();
    });

    $('#' + dashboard.id + ' .' + opts.widgetClass).die('widgetShow').live('widgetShow',function() {
      $(this).find('.' + opts.widgetContentClass).show();
    });

    $('#' + dashboard.id + ' .' + opts.widgetClass).die('widgetHide').live('widgetHide',function() {
      $(this).find('.' + opts.widgetContentClass).hide();
    });

    $('#' + dashboard.id + ' .' + opts.widgetClass).die('widgetAddMetadataValue').live('widgetAddMetadataValue',function(e,o) {
    ...
    $('#' + dashboard.id + ' .' + opts.widgetTitleClass).die('click').live('click',function(e) {
    ...
    $('#' + dashboard.id + ' .' + opts.widgetHeaderClass).die('mouseover').live('mouseover',function () {
      $(this).find('.' + opts.iconsClass).removeClass("hidden");
    });

    $('#' + dashboard.id + ' .' + opts.widgetHeaderClass).die('mouseout').live('mouseout', function () {
    ...
    $('#' + dashboard.id + ' .' + opts.widgetClass).die('widgetOpenFullScreen').live('widgetOpenFullScreen',function(e,o) {
      o.widget.openFullscreen();
    });

    $('.' + opts.widgetClass).die('widgetCloseFullScreen').live('widgetCloseFullScreen',function(e,o) {
      o.widget.closeFullscreen();
    });

    $('#' + dashboard.id + ' .' + opts.widgetClass).die('widgetEdit').live('widgetEdit',function(e,o) {
    ...
    $('.' + layoutOpts.openDialogClass).unbind('click').bind('click', function(){
      dashboard.log('dashboardOpenLayoutDialog event thrown',2);
      dashboard.element.trigger("dashboardOpenLayoutDialog");
      return false;
    });

    dashboard.element.die('dashboardOpenLayoutDialog').live('dashboardOpenLayoutDialog', function(){
    ...
    dashboard.element.die('dashboardStateChange').live('dashboardStateChange', function(){
    ...
    dashboard.element.die('dashboardCloseLayoutDialog').live('dashboardCloseLayoutDialog', function(){
      // close the dialog
    ...
    $('.' + addOpts.selectCategoryClass).die('click').live('click', function(){
    ...
    dashboard.element.die('addWidgetDialogSelectCategory').live('addWidgetDialogSelectCategory', function(e, obj){
    ...
    $('.' + addOpts.addWidgetClass).die('click').live('click', function(){
    ...
    $('.' + addOpts.openDialogClass).die('click').live('click', function(){
      dashboard.log('dashboardOpenWidgetDialog event thrown',2);
      dashboard.element.trigger('dashboardOpenWidgetDialog');
      return false;
    });

    dashboard.element.die('dashboardCloseWidgetDialog').live('dashboardCloseWidgetDialog', function(){
      // close the dialog
      $('#' + addOpts.dialogId).dialog('close');
    });

    dashboard.element.die('dashboardOpenWidgetDialog').live('dashboardOpenWidgetDialog', function(){
  ...
  $.fn.dashboard.defaults = {
    debuglevel:3,
    json_data: {},
    loadingHtml: '<div class="loading"><img alt="Loading, please wait" src="themes/kunanui/images/loading.gif" /><p>Loading...</p></div>',
    emptyColumnHtml: 'Arrastra tus paneles aqu&iacute;',
    widgetTemplate: 'widgettemplate',
    columnPrefix: 'column-',
    opacity:"0.2",
    deleteConfirmMessage: "Est\xe1 seguro de eliminar este panel?",
