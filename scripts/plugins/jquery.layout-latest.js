...
,	options = {
	...
	,	containerClass:				"ui-layout-container ui-widget" // layout-container element
...
,	addPane = function (pane, force) {
		...
		$P
			...
			.addClass( o.paneClass +" ui-widget-content "+ o.paneClass+"-"+pane ) // default = "ui-layout-pane ui-layout-pane-west" - may be a dupe of 'paneSelector'
