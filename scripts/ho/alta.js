		   		...
		   		var $grid = new K.grid({
					...
					fill: function(data,$row){
						...
						if(data.categoria!=null){
							cate = hoAlta.categoria[data.categoria];
						}
						...
						$row.data('id',data._id.$id).dblclick(function(){
							...
							bindings: {
								'conMenHoHosp_alt': function(t) {
									...
									function(){
										K.sendingInfo();
										$.post('ho/hosp/save_alta',{_id: K.tmp.data('id')},function(){
											K.clearNoti();
			...
			buttons: {
				"Guardar": {
					...
					f: function(){
						...
						$.post("ho/hosp/save_alta",data,function(result){
							K.clearNoti();
