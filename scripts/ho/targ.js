		   		...
		   		var $grid = new K.grid({
					...
					fill: function(data,$row){
						...
						$row.data('id',data._id.$id).dblclick(function(){
							hoTarg.windowNew({_id: $(this).data('id'),nomb: $(this).find('td:eq(2)').html()});
							...
							bindings: {
								'conMenListEd_edi': function(t) {
									hoTarg.windowNew({id: K.tmp.data('id'),nomb: K.tmp.find('td:eq(2)').html()});
								},
