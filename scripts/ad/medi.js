					...
					fill: function(data,$row){
						...
						$row.data('id',data._id.$id).data('data',data).dblclick(function(){
							K.WindowPrint({
								id:'windowPrint',
								title:"Informe ",
								url:"ad/medi/print?_id="+$(this).data('id')
							});
							...
							bindings: {
								'conMenFMedica_info': function(t) {
									adMedi.windowDetails({id: K.tmp.data('id'),nom: K.tmp.find('td:eq(2)').html()});
								},
				 				'conMenFMedica_edi': function(t) {
									adMedi.windowEdit({id: K.tmp.data('id'),nom: K.tmp.find('td:eq(2)').html()});
								},
								...
								'conMenFMedica_eli': function(t) {
									...
									function(){
										K.sendingInfo();
										$.post('ad/medi/delete',{_id: K.tmp.data('id')},function(){
											K.clearNoti();
								...
								'conMenFMedica_info':function(t){
									K.windowPrint({
										...
										url:"ad/medi/get_reporte?_id="+K.tmp.data('id')
									});
								},
	...
	windowNew: function(p){
		...
		new K.Modal({
					...
					f: function(){
						...
						var form = ciHelper.validator(p.$w.find('form'),{
							onSuccess: function(){
								...
								$.post("ad/medi/save",data,function(result){
									K.clearNoti();
			...
			onContentLoaded: function(){
				...
				$.post("ad/medi/get_reporte",function(data){
		...
		new K.Modal({ 
			...
			onContentLoaded: function(){
				...
				K.block();
				     ...
				     $.post('ad/medi/get',{_id: p.id},function(data){
