...
class repo extends FPDF
{
	...
	function Publicar($psicologica){
		...
		$this->SetXY(120,$y);$this->MultiCell(60,15,"Historia Clinica: ".$psicologica["paciente"]["roles"]["paciente"]["hist_cli"],'0','L');
		$y=$y+5;
		
		$this->SetXY(20,$y);$this->MultiCell(200,15,"Nombre(s): ".$psicologica["paciente"]["appat"].' '.$psicologica["paciente"]["apmat"].','.$psicologica["paciente"]["nomb"],'0','L');
		$y=$y+20;
