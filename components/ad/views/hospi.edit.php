...
<form class="form-horizontal" role="form">
	...
	<div name="paciente"><?php $f->response->view('mg/enti.mini'); ?></div>
				<!--<div class="form-group">
					...
					<div class="col-sm-8">
						<span class="form-control" name="doc"  style="width:250px"></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-4 control-label">Apellidos: </label>
					<div class="col-sm-8">
						<span class="form-control" name="ape"  style="width:250px"></span>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-4 control-label">Nombres: </label>
					<div class="col-sm-8">
						<span class="form-control" name="nom"  style="width:250px"></span>
					</div>
				</div>-->
				<div class="form-group">
				...
				<!--<div class="form-group date" data-provide="datepicker" >
					...
					<div class="col-sm-7.5 input-group">
						<input type="text" class="form-control"  name="fecini" style="width:300px" required>
					</div>
				</div>-->
				<div class="form-group" >
					<label class="col-sm-4 control-label">Fecha de Ingreso: </label>
