<?php
class Model_ad_cmmo extends Model {
	private $db;
	public $items;
	
	public function __construct(){
		global $f;
		$this->db = $f->datastore->ad_camas_movimientos;
	}
	...
	protected function get_cama(){
		global $f;
		$params=$this->params;
		if(isset($params['pabellon'])) 
			$filter['pabellon']=$params['pabellon'];
		if(isset($this->params['sala'])) 
			$filter['sala']=$params['sala'];
		if(isset($this->params['cama'])) 
			$filter['cama._id']=$params['_id'];
		if(isset($this->params['ubicacion'])) 
			$filter['ubicacion']=$params['ubicacion'];
