<?php
class Model_ad_psiq extends Model {
	private $db;
	public $items;
	
	public function __construct() {
		global $f;
		$this->db = $f->datastore->ad_fichaspsiquiatricas;
	}
	...
	protected function get_reporte(){
		...
		$data = $this->db->find($filter, array('clin'=>1,'paciente'=>1,'paciente.appat'=>1,'paciente.apmat'=>1,'edad'=>1,'moti'=>1))->sort(array('clini'=>-1));
		foreach ($data as $obj) {
		    $this->items[] = $obj;
		}
	}
