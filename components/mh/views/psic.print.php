...
class repo extends FPDF
{
	...
	function Header(){
		...
		$this->SetXY(10,5);$this->MultiCell(60,5,"SOCIEDAD DE BENEFICENCIA AREQUIPA",'0','C');		
		$this->SetXY(10,5);$this->MultiCell(190,5,date("d/m/Y")." Página: ".$this->PageNo()."/{nb}",'0','R');
		$this->SetFont('Arial','',9);
		$this->SetXY(10,15);$this->MultiCell(60,5,"Centro de Salud Mental y Adicciones",'0','C');
		$this->SetXY(10,20);$this->MultiCell(60,5,"'Moises Heresi Farwagi'",'0','C');
	...
	function Publicar($psicologica){
		...
		$this->SetFont('Arial','B',13);
		$y=$y+60;
		$this->SetXY(30,$y);$this->MultiCell(150,5,"Conclusión Diagnostica Y Recomendaciones: ",'0','L');
		$y=$y+5;
		$this->SetFont('Arial','',11);
