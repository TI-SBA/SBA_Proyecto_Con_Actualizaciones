...
//CABECERA
		...
		$this->SetXY(5,35);$this->MultiCell(180,5,"DRA. ELIZABETH CESPEDES",'0','C');
		...
		for($i = 0;$i<count($reporte);$i++){ 
			...
			for($j = 0;$j<count($reporte[$i]['consulta']);$j++){
				...
				if(floatval($reporte[$i]["consulta"][$j]['paciente']['sexo']) == 0 & floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'AD'){
					$mujeres_pagante++;
				}
				if(floatval($reporte[$i]["consulta"][$j]['paciente']['sexo']) == 1 & floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'AD'){
					$varones_pagante++;
				}
				if(floatval($reporte[$i]["consulta"][$j]['paciente']['sexo']) == 0 & floatval($reporte[$i]["consulta"][$j]['cate']) == 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'AD'){
					$mujeres_indigente++;
				...
				if($edad<6 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'AD'){
					$edad1_p++;
				}

				if($edad>=6 && $edad<11 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'AD'){
					$edad2_p++;
				}

				if($edad>=11 && $edad<16 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'AD'){
					$edad3_p++;
				}

				if($edad>=16 && $edad<21 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'AD'){
					$edad4_p++;
				}
				if($edad>=21 && $edad<31 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'AD'){
					$edad5_p++;
				}
				if($edad>=31 && $edad<51 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'AD'){
					$edad6_p++;
				}
				if($edad>=51 && $edad<61 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'AD'){
					$edad7_p++;
				}
				if($edad>=61 && $edad<100 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'AD'){
					$edad8_p++;
				}


				if($edad>=0 && $edad<6 && floatval($reporte[$i]["consulta"][$j]['cate']) == 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'AD'){
					$edad1_i++;
				}
		...
		for($i = 0;$i<count($reporte);$i++){
			...
			for($j = 0;$j<count($reporte[$i]['consulta']);$j++){
				...
				if(floatval($reporte[$i]["consulta"][$j]['paciente']['sexo']) == 0 & floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'MH'){
					$mujeres_pagante++;
				}
				if(floatval($reporte[$i]["consulta"][$j]['paciente']['sexo']) == 1 & floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'MH'){
					$varones_pagante++;
				}
				if(floatval($reporte[$i]["consulta"][$j]['paciente']['sexo']) == 0 & floatval($reporte[$i]["consulta"][$j]['cate']) == 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'MH'){
					$mujeres_indigente++;
				...
				if($edad<6 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'MH'){
					$edad1_p++;
				}

				if($edad>=6 && $edad<11 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'MH'){
					$edad2_p++;
				}

				if($edad>=11 && $edad<16 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'MH'){
					$edad3_p++;
				}

				if($edad>=16 && $edad<21 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'MH'){
					$edad4_p++;
				}
				if($edad>=21 && $edad<31 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'MH'){
					$edad5_p++;
				}
				if($edad>=31 && $edad<51 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'MH'){
					$edad6_p++;
				}
				if($edad>=51 && $edad<61 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'MH'){
					$edad7_p++;
				}
				if($edad>=61 && $edad<100 && floatval($reporte[$i]["consulta"][$j]['cate']) != 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'MH'){
					$edad8_p++;
				}


				if($edad>=0 && $edad<6 && floatval($reporte[$i]["consulta"][$j]['cate']) == 8 && $reporte[$i]['consulta'][$j]['esta'] != '5' && $reporte[$i]['medico']['_id'] =='5b6dce0f3e6037532f8b456b' && $reporte[$i]['modulo'] == 'MH'){
					$edad1_i++;
				}
