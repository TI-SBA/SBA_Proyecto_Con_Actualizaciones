...
<form class="form-horizontal" role="form">
	...
	<div class="form-group">
		...
		<ddiv>
			...
			<div class="col-md-3">
			<select class="form-control" name="grad" type = "text" style="width:300px" disabled="disabled" required>
...
-->			
	...
	<div class="form-group row has-success">
		<label class="col-sm-3 control-label">Motivo Actual de la consulta</label>
			<div class="col-md-3">
				<textarea cols="30" rows="3" class="form-control" name="moti" style="width:950px"></textarea>
			</div>
	</div>
	<div class="form-group row has-success">
		<label class="col-sm-3 control-label">Soluciones Intentadas</label>
			<div class="col-md-3">
				<textarea cols="30" rows="3" class="form-control" name="solu" style="width:950px"></textarea>
			</div>
	</div>
	<div class="form-group row has-success">
		<label class="col-sm-3 control-label">Estresores Psicosociales</label>
			<div class="col-md-3">
				<textarea cols="30" rows="3" class="form-control" name="estr" style="width:950px"></textarea>
			</div>
	</div>
	<div class="form-group row has-success">
		<label class="col-sm-3 control-label">Situaci&oacute;n Economica</label>
			<div class="col-md-3">
				<textarea cols="30" rows="3" class="form-control" name="site" style="width:950px"></textarea>
			</div>
	</div>
	<div class="form-group row has-success">
		<label class="col-sm-3 control-label">Situaci&oacute;n de Salud</label>
			<div class="col-md-3">
				<textarea cols="30" rows="3" class="form-control" name="sits" style="width:950px"></textarea>
			</div>
	</div>
	<div class="form-group row has-success">
		<label class="col-sm-3 control-label">Vivienda</label>
			<div class="col-md-3">
				<textarea cols="30" rows="3" class="form-control" name="vivi" style="width:950px"></textarea>
			</div>
	</div>
	<div class="form-group row has-success">
		<label class="col-sm-3 control-label">Problem&aacute;tica del Paciente</label>
			<div class="col-md-3">
				<textarea cols="30" rows="3" class="form-control" name="prob" style="width:950px"></textarea>
			</div>
	</div>
</form>
