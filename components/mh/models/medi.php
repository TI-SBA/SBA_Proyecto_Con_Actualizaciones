<?php
class Model_mh_medi extends Model {
	private $db;
	public $items;
	
	public function __construct() {
		global $f;
		$this->db = $f->datastore->mh_fichasMedicas;
	}
	...
	protected function get_reporte(){
		global $f;
		$data = $this->db->find(array(), array('paci'=>1,'diag'=>1,'tra'=>1,'inter'=>1,'agres'=>1,'visi'=>1,'peso'=>1))->sort(array('paci'=>-1));
		foreach ($data as $obj) {
		    $this->items[] = $obj;
		}
