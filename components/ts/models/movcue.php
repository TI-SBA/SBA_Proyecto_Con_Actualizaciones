<?php
class Model_ts_movcue extends Model {
	private $col;
	public $items;
	
	public function __construct() {
		global $f;
		$this->col = $f->datastore->ts_movimientos_cuenta;
	}
	...
	protected function get_all_periodo(){
		global $f;
		$data = $this->col->find(array('periodo'=>$this->params['periodo'],'cuenta_banco._id'=>$this->params['ctban']));
		foreach ($data as $ob) {
		    $this->items[] = $ob;
		}
	}
