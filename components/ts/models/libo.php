<?php
class Model_ts_libo extends Model {
	private $db;
	public $items;
	
	public function __construct() {
		global $f;
		$this->db = $f->datastore->ts_libro_bancos;
	}
	...
	protected function get_saldo(){
		global $f;
		$data = $this->db->find(array())->sort(array('Libro.saldo_final'=>-1))->limit(1);
		foreach ($data as $obj) {
		    $this->items = $obj;
		}
		//print_r($obj);
...
//		print_r($fields);
	...
	protected function delete_libo(){
		global $f;
