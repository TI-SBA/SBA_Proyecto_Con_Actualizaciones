<?php
class Model_in_play extends Model {
	private $db;
	public $items;
	
	public function __construct() {
		global $f;
		$this->db = $f->datastore->in_playas;
	}
	...
	protected function get_por_cuenta(){
		global $f;
		$this->items = $this->db->findOne(array('cuenta._id'=>$this->params['_id']));
	}
