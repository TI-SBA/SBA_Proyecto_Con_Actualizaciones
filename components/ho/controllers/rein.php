<?php
class Controller_ho_rein extends Controller {
	function execute_lista(){
		...
		/*if(isset($f->request->data['modulo']))
			...
			$params["modulo"]= array('$in'=>array("LM","AD","MH"))
		}*/
		/*-----------------------------------*/

		if(isset($f->request->data['sort']))
			$params['sort'] = array($f->request->data['sort']=>floatval($f->request->data['sort_i']));
		$f->response->json( $f->model("cj/rein")->params($params)->get("lista_2") );
	}
	function execute_print(){
		...
		$f->response->view("ho/rein.print",array('recibo'=>$recibo));
	}
}
?>