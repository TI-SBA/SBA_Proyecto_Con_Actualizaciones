...
class repo extends FPDF
{
	...
	function Header(){
		...
		$this->setXY(75,20);$this->Cell(60,10,"CUENTAS PRESUPUESTARIAS DE INGRESO",0,0,'C');
		...
		$this->SetXY(25,50);$this->MultiCell(40,5,"COMPROBANTE",'1','C');
		$this->SetXY(25,55);$this->MultiCell(15,5,"CLASE",'1','C');
		$this->SetXY(40,55);$this->MultiCell(25,5,"Nro",'1','C');
		$this->SetXY(65,50);$this->MultiCell(105,10,"DESCRIPCIÓN",'1','C');
			
		$this->SetXY(170,50);$this->MultiCell(60,5,"EJECUCION DE PRESUPUESTO",'1','C');
		...
		$this->SetXY(230,50);$this->MultiCell(60,5,"EJECUCION DE INGRESOS",'1','C');
