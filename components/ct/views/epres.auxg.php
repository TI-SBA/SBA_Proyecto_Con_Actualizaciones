	<table>
			...
			<tr>
				<td colspan="2"><b><label>Sub-Especif&iacute;ca</label></b> <span name="clas_esp"></span><button name="btnEsp">Seleccionar</button></td>
				<td><label>Meta</label> <span name="meta"></span> <button name="btnMeta">Seleccionar</button></td>
			</tr>
			<tr>
				<td colspan="3"><b><label>Descripci&oacute;n</label></b> <span name="descr_esp"></span></td>
			</tr>
		</table>		
	<div class="grid">
		<div class="gridHeader ui-state-default ui-jqgrid-hdiv" style="position: relative;">
			<ul>
				...
				<li class="ui-button ui-widget ui-state-default ui-button-text-only" style="min-width:240px;max-width:240px;">
					<ul style="display:block">
						<li class="ui-button ui-widget ui-state-default ui-button-text-only" style="min-width:240px;max-width:240px;">Asignaciones Comprometidas</li>
					</ul>
					<ul style="display:block">
						<li class="ui-button ui-widget ui-state-default ui-button-text-only" style="min-width:80px;max-width:80px;">Debe</li>
						<li class="ui-button ui-widget ui-state-default ui-button-text-only" style="min-width:80px;max-width:80px;">Haber</li>
				...
				<li class="ui-button ui-widget ui-state-default ui-button-text-only" style="min-width:240px;max-width:240px;">
					<ul style="display:block">
						<li class="ui-button ui-widget ui-state-default ui-button-text-only" style="min-width:240px;max-width:240px;">Ejecuci&oacute;n de Gastos</li>
					</ul>
					<ul style="display:block">
						<li class="ui-button ui-widget ui-state-default ui-button-text-only" style="min-width:80px;max-width:80px;">Debe</li>
						<li class="ui-button ui-widget ui-state-default ui-button-text-only" style="min-width:80px;max-width:80px;">Haber</li>
