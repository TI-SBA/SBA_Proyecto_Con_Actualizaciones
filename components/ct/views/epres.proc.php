	<table>
			...
			<tr>
				<td><b><label>Actividad</label></b> <span name="actividad"></span></td>
				<td><b><label>Componente</label></b> <span name="componente"></span></td>
	...
	<div class="grid">
		<div class="gridHeader ui-state-default ui-jqgrid-hdiv" style="position: relative;">
			<ul>
				...
				<li class="ui-button ui-widget ui-state-default ui-button-text-only" style="min-width:150px;max-width:150px;">Ingresos del Mes</li>		
