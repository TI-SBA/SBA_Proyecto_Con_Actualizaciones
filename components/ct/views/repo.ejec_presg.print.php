...
class pmen extends FPDF
{
	...
	function Header(){
		...
		$this->setY(10,10);$this->MultiCell(347,5,"PRESUPUESTO AUTORIZADO Y EJECUCION DE GASTOS DEL AÑO ".$this->filtros["ano"]." ".(isset($this->filtros["organizacion"])?"POR DEPENDENCIAS":"CONSOLIDAD"),'0','C');
