...
<fieldset>
<legend>Ejecuci&oacute;n de Ingresos</legend>
	<table>
		<tr>
			<td><b><label>Tipo</label></b></td>
			<td>
			<span name="RadEjeIng">
				<input type="radio" name="rbtnRadEjeIng" id="RadEjeIngDebe" value="D" checked="checked"><label for="RadEjeIngDebe">Debe</label>
				<input type="radio" name="rbtnRadEjeIng" id="RadEjeIngHaber" value="H"><label for="RadEjeIngHaber">Haber</label>
			</span>
			</td>
		</tr>
		<tr>
			<td><b><label>Monto</label></b></td>
			<td><input type="text" name="monto_ejec_ing"></td>
		</tr>
	</table>
</fieldset>
<fieldset>
