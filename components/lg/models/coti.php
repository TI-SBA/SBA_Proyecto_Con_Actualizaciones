<?php
class Model_lg_coti extends Model {
	private $db;
	public $items;
	
	public function __construct() {
		global $f;
		$this->db = $f->datastore->lg_cotizaciones;
	}
	...
	protected function save_propuesta(){
		global $f;
		$this->db->update( array('_id'=>$this->params['_id']) , array('$push'=>array('propuesta'=>$this->params['data'])) );
	}
	protected function delete_coti(){
		global $f;
		$this->db->update( array('_id'=>$this->params['_id']) , array('$pull'=>array('propuesta'=>array('num'=>$this->params['num']))) );
	}
}
?>