...
<div class="ui-layout-center">
	...
	<fieldset name="section5">
		...
		<table>
			...
			<tr>
				...
				<td><span>De </span><span name="spFecini"></span></td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td><span>A </span><input type="text" name="fecfin"></td>
			</tr>
			<tr>
			...
			<tr>
				<td><label>Renta (Sin IGV)</label></td>
	...
	<fieldset name="section6">
		...
		<div class="grid" style="width: 480px;max-height: 200px;">
	...
	<fieldset name="section7">
		...
		<div class="grid payment" style="max-height: 300px;width: 480px;">
