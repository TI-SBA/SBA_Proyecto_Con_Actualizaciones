...
<div class="ui-layout-center">
	<fieldset name="section1">
		...
		<table>
			<tr>
				<td rowspan="3"><button name="btnBus">Buscar</button></td>
	...
	<fieldset name="section3">
		...
		<table>
			<tr>
				<td rowspan="3" width="90"><button name="btnBus">Buscar</button></td>
	...
	<fieldset name="section4">
		...
		<table>
			<tr>
				<td rowspan="3"><button name="btnBus">Buscar</button>
	...
	<fieldset name="section5">
		...
		<table>
			<tr>
				...
				<td><span>Primer Arrendamiento</span></td>
			</tr>
			<tr>
