...
<div class="ui-layout-center">
	...
	<fieldset name="section2">
		...
		<table>
			<tr>
				<td width="176"><select name="espacio"></select></td>
			</tr>
		</table>
	...
	<fieldset name="section3">
		...
		<table>
			<tr>
				<td><label>Permanente</label></td>
			</tr>
			<tr>
				<td><label>Nuevo Propietario (opcional):</label></td>
			</tr>
			<tr>
				<td><span name="new_prop"></span>&nbsp;<button name="btnBus">Buscar</button>&nbsp;<button name="btnNew">Agregar</button></td>
			</tr>
		</table>
	</fieldset>
		...
		<div name="tabs">
			...
			<div id="tabsConcPayment-1">
				<table>
					...
					<tr>
						<td><label>Fecha de Emisi&oacute;n para Vencimiento</label></td>
