...
<div class="ui-layout-center">
	...
	<fieldset name="section2">
		...
		<select style="width:250px;" name="difunto"></select>
		<div><table cellpadding="2" name="detDifunto"></table></div>
	</fieldset>
	...
	<fieldset name="section4">
		...
		<table cellpadding="2">
				<tr name="rowInterno">
					<td width="176"><button name="btnSelEspacio">Seleccionar Espacio</button></td>
				</tr>
				<tr name="rowExterno">
				...
				<tr name="rowCoactivo">
					...
					<td><span name="coactivo">Coactivo</span></td>
				</tr>
		</table>
		<div name="rowInterno"><table name="destino" cellpadding="3"></table></div>
		<span name="desEspa" style="display: none;"></span>
	</fieldset>
