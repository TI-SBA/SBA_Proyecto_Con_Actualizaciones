...
class Controller_pr_navg extends Controller {
	function execute_index() {
		...
		if(isset($f->session->tasks['pr.meta'])) $data[] = array("name"=>"prMeta","descr"=>'Metas',"icon"=>"ui-icon-tag");
		if(isset($f->session->tasks['pr.meta'])) $data[] = array("name"=>"prMefi","descr"=>'Metas Fisicas',"icon"=>"ui-icon-tag");
		if(isset($f->session->tasks['pr.meta'])) $data[] = array("name"=>"prRese","descr"=>'Reservas Presupuestales',"icon"=>"ui-icon-tag");
