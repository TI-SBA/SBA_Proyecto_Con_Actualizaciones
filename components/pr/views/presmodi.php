<div>
	<table>
		...
		<tr>
			...
			<td>&nbsp;<button name="btnAgregar">Credito Suplementario</button>&nbsp;<button name="btnAgregarNota">Nota Modificatoria</button></td>
		</tr>
	</table>
</div>
	<div class="gridHeader ui-state-default ui-jqgrid-hdiv">
		...
		<ul>		
			...
			<li class="ui-button ui-widget ui-button-text-only" style="min-width:250px;max-width:250px;">Clasificador</li>
