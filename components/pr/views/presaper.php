<div>
	<table>
		<tr>
			...
			<td><label name="prognomb"></label></td>
			<td name="FilProg">
				<input type="hidden" name="programa" value="">
				<input type="radio" name="rbtnProg" id="rbtnProgSelect" value="S"><label for="rbtnProgSelect">Seleccionar</label>
				<input type="radio" name="rbtnProg" id="rbtnProgX" value="X" checked="checked"><label for="rbtnProgX">X</label>
			</td>
