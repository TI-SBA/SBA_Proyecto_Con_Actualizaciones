<?php
class Model_us_prog extends Model {
	private $db;
	public $items;
	
	public function __construct() {
		global $f;
		$this->db = $f->datastore->us_programaciones;
	}
	...
	protected function get_ini(){
		global $f;
		$this->items = $this->db->findOne(array('ini'=>$this->params['ini']));
	}
	protected function get_ini_aprob(){
		global $f;
		$this->items = $this->db->findOne(array('ini'=>$this->params['ini'],'estado'=>'P'));
	}
