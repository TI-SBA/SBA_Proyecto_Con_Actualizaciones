	...
	function Publicar($diario){
		...
		for($i = 0;$i<count($diario);$i++){
			...
			for($j = 0;$j<count($diario[$i]['consulta']);$j++){
				...
				//SEXO
				if(floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 0 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$mujeres++;
				}
				if(floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 1 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$varones++;
				}
				//CATEGORIA
				
				if(floatval($diario[$i]["consulta"][$j]['cate']) != 8 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$pagante++;
				}
				if(floatval($diario[$i]["consulta"][$j]['cate']) == 8 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$indigente++;
				...
				//EDAD
				if($edad<=5 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 0 && $diario[$i]['consulta'][$j]['esta'] != '5'){

				$edad1M++;
				}
				if($edad>=0 && $edad<=5 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 1 && $diario[$i]['consulta'][$j]['esta'] != '5'){
				$edad1F++;
				}
				if($edad>=6 && $edad<=10 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 0 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad2M++;
				}
				if($edad>=6 && $edad<=10 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 1 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad2F++;
				}
				if($edad>=11 && $edad<=15 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 0 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad3M++;
				}
				if($edad>=11 && $edad<=15 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 1 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad3F++;
				}
				if($edad>=16 && $edad<=20 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 0 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad4M++;
				}
				if($edad>=16 && $edad<=20 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 1 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad4F++;
				}
				if($edad>=21 && $edad<=30 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 0 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad5M++;
				}
				if($edad>=21 && $edad<=30 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 1 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad5F++;
				}
				if($edad>=31 && $edad<=50 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 0 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad6M++;
				}
				if($edad>=31 && $edad<=50 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 1 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad6F++;
				}
				if($edad>=51 && $edad<=60 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 0 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad7M++;
				}
				if($edad>=51 && $edad<=60 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 1 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad7F++;
				}
				if($edad>=61 && $edad<=100 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 0 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad8M++;
				}
				if($edad>=61 && $edad<=100 && floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 1 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad8F++;
				}
			}
		}
		$total = 0;
		$total = $total_consultas - $inter;
		/*
		print_r($total_consultas);
		echo "/";
		print_r($inter);
		echo "/";
		print_r($total);
