...
class repo extends FPDF
{
	function Header(){
		...
		$this->SetXY(5,30);$this->MultiCell(200,5,	"FICHA DE REPORTE MENSUAL DE SERVICIOS - SOCIEDAD DE BENEFICIENCIA DE AREQUIPA - REPORTE QUINCENAL DE SERVICIOS",'0','C');
...
//CABECERA
		...
		for($i = 0;$i<count($diario);$i++){
			...
			//print_r($diario[$i]);die();
			for($j = 0;$j<count($diario[$i]['consulta']);$j++){
				if(isset($diario[$i]["consulta"][$j]['paciente']['fecha_na'])){
					/*
					if($diario[$i]['consulta'][$j]['cate'] == '8'){
						
						print_r($diario[$i]["consulta"][$j]['paciente']['paciente']['nomb']);
						echo(" ");
						print_r($diario[$i]["consulta"][$j]['paciente']['paciente']['appat']);
						echo(" ");
						print_r($diario[$i]["consulta"][$j]['paciente']['paciente']['apmat']);
						echo(" ");
						print_r($diario[$i]["fecreg"]->sec);
						echo(" ");
						echo("-");
				...
				if(floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 0 & floatval($diario[$i]["consulta"][$j]['cate']) != 8 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$mujeres_pagante++;
				}
				if(floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 1 & floatval($diario[$i]["consulta"][$j]['cate']) != 8 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$varones_pagante++;
				}
				if(floatval($diario[$i]["consulta"][$j]['paciente']['sexo']) == 0 & floatval($diario[$i]["consulta"][$j]['cate']) == 8 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$mujeres_indigente++;
				...
				*/
				if($edad<6 && floatval($diario[$i]["consulta"][$j]['cate']) != 8 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad1_p++;
				}

				if($edad>=6 && $edad<11 && floatval($diario[$i]["consulta"][$j]['cate']) != 8 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad2_p++;
				}

				if($edad>=11 && $edad<16 && floatval($diario[$i]["consulta"][$j]['cate']) != 8 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad3_p++;
				}

				if($edad>=16 && $edad<21 && floatval($diario[$i]["consulta"][$j]['cate']) != 8 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad4_p++;
				}
				if($edad>=21 && $edad<31 && floatval($diario[$i]["consulta"][$j]['cate']) != 8 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad5_p++;
				}
				if($edad>=31 && $edad<51 && floatval($diario[$i]["consulta"][$j]['cate']) != 8 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad6_p++;
				}
				if($edad>=51 && $edad<61 && floatval($diario[$i]["consulta"][$j]['cate']) != 8 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad7_p++;
				}
				if($edad>=61 && $edad<100 && floatval($diario[$i]["consulta"][$j]['cate']) != 8 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad8_p++;
				}


				if($edad>=0 && $edad<6 && floatval($diario[$i]["consulta"][$j]['cate']) == 8 && $diario[$i]['consulta'][$j]['esta'] != '5'){
					$edad1_i++;
				}
