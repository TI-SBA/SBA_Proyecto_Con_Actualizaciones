...
class repo extends FPDF
{
	...
	function Header(){
		...
		//$title = "";
		//if($this->filtros[""])
		$this->SetXY(10,25);$this->MultiCell(180,5,"ASIGNACION POR 30 AÑOS DE SERVICIO",'0','C');
	...
	function Publicar($items){
		...
		$this->SetFont('arial','',9);
		$this->SetXY(15,$y);$this->MultiCell(180,5,"De conformidad con lo dispuesto en el Art.54 inc. a) del D.Leg Nº 276, que establece el pago de una asignacion equivalente a (03) tres remuneraciones totales mensuales, por haber cumplido 30 años de servicio en la Administración Pública, beneficio que se otorga por única vez al trabajador, de acuerdo al siguiente detalle:",'0','L');
		$y=$this->GetY()+5;
		...
		$this->SetXY(150,$y);$this->MultiCell(45,5,number_format($items["total"],2)."  X  3      S/. ".number_format($items["neto"],2),'0','R');
		$y+=5;
