...
<fieldset>
	...
	<input name="elemento1" type="checkbox" value="1" checked="checked" /> Se incluyen Beneficios Sociales<br />
	<div name="beneficios">
		...
		<table>
			<tr>
				...
				<td width="170px"><span name="bene_remu"></span> / 2 X <input type="text" name="total_anos_bene" size="3"> a&ntilde;os = </td>
...
<fieldset>
	...
	<table>
		...
		<tr>
			<td>Meses</td>
			<td><input type="text" size="4" name="meses" value="1"></td>
		</tr>
		<tr>
			<td>D&iacute;as</td>
			<td><input type="text" size="4" name="dias" value="0"></td>
		</tr>
	</table>
	<table>
		<tr>
