...
class repo extends FPDF
{
	...
	function Header(){
		...
		//$title = "";
		//if($this->filtros[""])
		$this->SetXY(10,25);$this->MultiCell(180,5,"LIQUIDACION COMPENSACION VACACIONAL",'0','C');
	...
	function Publicar($items){
		...
		$this->SetXY(15,$y);$this->MultiCell(180,5,"1.- VACACIONES FISICAS NO GOZADAS",'0','L');
		$y+=5;
		$this->SetFont('arial','',9);
		$this->SetXY(15,$y);$this->MultiCell(180,5,"De Conformidad a lo dispuesto en el Art. 104 del D.Leg Nº 276 y D.S.005-90-PCM e Inf Nº 079-2006-SBPA-OEAL al e",'0','L');
		$y+=5;
