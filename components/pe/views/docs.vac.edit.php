...
<fieldset>
    ...
    <table>
    	...
    	<tr>
            ...
            <td>Desde: <input type="text" name="ini" size="10"></span>&nbsp;Hasta: <input type="text" name="fin" size="10"></td>
        </tr>
    	<tr>
        	<td><label>N&uacute;mero de meses</label></td>
            <td><span name="meses"></span></td>
        </tr>
    	<tr>
        	<td><label>N&uacute;mero de d&iacute;as</label></td>
