<?php
class Model_pe_tipo extends Model {
	private $db;
	public $items;
	
	public function __construct() {
		global $f;
		$this->db = $f->datastore->pe_tipos_incidencias;
	}
	...
	protected function get_tipo(){
		global $f;
		$data = $this->db->find(array('tipo'=>$this->params['tipo'],'estado'=>'H'));
		foreach ($data as $ob) {
		    $this->items[] = $ob;
		}
	}
