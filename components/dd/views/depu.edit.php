<form class="form-horizontal" role="form">
	<div class="form-group">
		<label class="col-sm-3 control-label">Nombre:</label>
			<div class="col-sm-9">
				<input type="text" class="form-control"  name="nomb" style="width:250px" required>
			</div>
	</div>
	<!--
	<div class="form-group">
	...
	<div class="form-group">
		<label class="col-sm-3 control-label">Metraje:</label>
			<div class="col-sm-9">
				<input type="text" class="form-control"  name="metr" style="width:250px" required>
			</div>
	</div>
	<div class="form-group">
		<label class="col-sm-3 control-label">Cajas o Sacos:</label>
			<div class="col-sm-9">
				<input type="text" class="form-control"  name="casa" style="width:250px" required>
			</div>
	</div>
	<div class="form-group" >
