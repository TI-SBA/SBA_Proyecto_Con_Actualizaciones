...
class repo extends FPDF
{
	function Header(){
		...
		$this->SetXY(5,30);$this->MultiCell(200,5,	"LISTA DE TIPOS DE DOCUMENTOS",'0','C');
	...
	function Publicar($tipo){
		...
		for($i=0;$i<count($tipo);$i++){
			...
			$this->SetXY(50,$y);$this->MultiCell(45,9,"".$tipo[$i]["tipo"],'0','C');
			$this->SetXY(95,$y);$this->MultiCell(35,9,"".$tipo[$i]["desc"],'0','C');
